                        ...
                        <tr>
                            ...
                            <td>
                                <b><a href="#" class='btn btn-danger btn-sm' data-toggle="modal" data-target="#delete"
                                        id="<?php echo $id = $row[" id"]?>">Delete</a></b>
                            </td>
                        </tr>
                        <?php
              $count++;
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Are you sure you want to create new Tank?
                                    </h4>
                                </div>
                                    ...
                                    <form role="form" method="post">
                                        <fieldset>
                                            ...
                                            <button type="submit" name="add"
                                                class="btn btn-lg btn-success btn-block">Create acount</button>
                                        </fieldset>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                    <h4 class="modal-title" id="myModalLabel">Are you sure you want to delete this User?
                                    </h4>
                                </div>
                                <div class="modal-body">
                                    <?php
                                    ...
                                    <form role="form" method="post">
                                        <fieldset>
                                            ...
                                            <input class="form-control" id="disabledInput" type="text"
                                                placeholder="<?php echo $row['names'] ?>" disabled><br>
                                            <label>Cell </label>
                                            <input class="form-control" id="disabledInput" type="text"
                                                placeholder="<?php echo $row['cell'] ?>" disabled><br>
                                            <label>Description </label>
                                            <input class="form-control" id="disabledInput" type="text"
                                                placeholder="<?php echo $row['description'] ?>" disabled><br>
                                            <button type="submit" name="delete"
                                                class="btn btn-lg btn-danger btn-block">Delete</button>
                                        </fieldset>
                                    </form>
                                </div>
                            </div>
